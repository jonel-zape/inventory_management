...
namespace Inventory_System.ui
{
    class CustomDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.icons8_calendar_16_white;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.icons8_calendar_16;
                else calendarIcon = Properties.Resources.icons8_calendar_16_white;
                this.Invalidate();
            }
        }
